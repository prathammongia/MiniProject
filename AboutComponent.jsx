...
import myimage from './aboutme.jpg';
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="about-col-2">
            ...
            <p className="aboutme">
              <span>Pratham Mongia <br />Second-year Undergraduate in Computer Science<br /> Vellore Institute of Technology, Vellore<br /><br />
              ...
              <br /><br />
              <span>Hobbies:</span>
              Passionate about dramatics,chess and music.
              <br /><br />
              <span>Objective:</span>
            ...
            <div className={`tab-contents ${activeTab === 'education' ? 'active-tab' : ''}`} id="education">
              <ul>
                <li><span>2024- Current</span><br />2nd Year Student -  8.44 CGPA<br />Vellore Institute of Technology,Vellore</li>
                <li><span>2022</span><br />Senior Secondary<br/>KVS</li>
                <li><span>2020</span><br />Secondary<br />KVS,AFS</li>
              </ul>
            </div>
          </div>
        </div>
